...
namespace CodeBase.Infrastructure.Factories.SaveTrigger
{
  public class SaveTriggerFactory : ISaveTriggerFactory
  {
    ...
    public async Task<GameObject> CreateSaveTrigger(string id, TransformData transformData, BoxColliderData boxColliderData, Vector3 firePosition)
    {
      ...
      saveTriggerObject.GetComponent<Gameplay.Logic.Save.SaveTrigger>().Construct(id, firePosition, _saveLoadService, _assets);
